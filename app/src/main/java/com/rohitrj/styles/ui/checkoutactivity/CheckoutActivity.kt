package com.rohitrj.styles.ui.checkoutactivity
...
import com.rohitrj.styles.internals.utils.PaymentsUtil
import com.rohitrj.styles.internals.utils.microsToString
...
class CheckoutActivity : AppCompatActivity() {
    ...
    private fun requestPayment() {
        ...
        val garmentPriceMicros = (50f * 1000000).roundToLong()
    ...
    private fun handlePaymentSuccess(paymentData: PaymentData) {
        ...
        try {
            ...
            Toast.makeText(this, "Payment Success $billingName", Toast.LENGTH_LONG).show()
